...
export const metadata = {
  ...
  openGraph: {
    type: 'website',
    url: 'https://my-screen-device-size.vercel.app/hide-my-ip-address',
    ...
    images: ['https://my-screen-device-size.vercel.app/preview-hide-ip.png'],
  },
  twitter: {
  ...
  alternates: {
    canonical: 'https://my-screen-device-size.vercel.app/hide-my-ip-address',
  },
};
